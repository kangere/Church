...
public class PastEvents extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.Past_eventsToolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitle("Past Events");
        toolbar.setTitleTextColor(Color.WHITE);

        //drawer layout init
        drawerLayout = (DrawerLayout) findViewById(R.id.past_events_drawer_layout);


        //navigation fragment init
        NavigationFragment navigationFragment = (NavigationFragment) getSupportFragmentManager().findFragmentById(R.id.past_events_fragment_navigation_drawer);
